...
class Client:
    ...
    def _api_base(
        self, method, url, api: API, params=None, site_id: Optional[str] = None
    ):
    ...
    def _api_update(
        ...
        return self._response_process(self._api_base("put", url, api, params, site_id))
    ...
    def _verify_network_type(self):
        ...
        if p == "network":
            ...
            self.login_path = "api/auth/login"
        else:
            self.login_path = "api/login"

    def get_sites_overview(self, search_text=""):
    ...
    def add_dhcp_reservation(self, data: dict):
        self._api_write("rest/user", params=data, api=API.v1)
